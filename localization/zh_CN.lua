...
return {
    descriptions = {
        Back = {
            ...
            b_poke_stadiumdeck = {
                ...
                text = {
                    "开局额外获得",
                    "{C:attention,s:0.6}奖励牌、倍率牌、",
                    "{C:attention,s:0.6}万能牌、玻璃牌、",
                    "{C:attention,s:0.6}万能牌、玻璃牌、",
                    "{C:attention,s:0.6}黄金牌{s:0.6}和{C:attention,s:0.6}幸运牌{s:0.6}各一张"
                } 
            },
            b_poke_megadeck = {
                name = "超进化卡组",
                text = {
                    "开局拥有",
                    "{C:tarot,T:v_reroll_surplus}#2#{}和{C:tarot,T:v_reroll_glut}#3#{}券",
                    "及{C:spectral,T:c_poke_megastone}#1#{}卡",
                    "{C:red}-#4#{}商店栏位"
                } 
            },
            b_poke_vendingdeck = {
                name = "自动贩卖机卡组",
                text = {
                    "击败每个{C:attention}奇数首领盲注{}后",
                    "获得{C:attention,T:tag_vremade_double}#1#",
                } 
            },
        },
        Blind = {
        ...
        Item = {
            ...
            c_poke_teraorb = {
                name = "太晶珠",
                text = {
                    "{C:attention}属性变换:{} {X:pink,C:white}随机{}",
            ...
            c_poke_duskstone = {
                ...
                text = {
					...
					"{C:attention}#2#{} 回合后 {C:inactive}[#3#]{}，改为",
					"每张小丑牌只获得 {C:money}$#1#{}",
            ...
            c_poke_heartscale = {
                ...
                text = {
                    "此为{C:attention}消耗品{}",
                    "选择{C:attention}#1#{}张牌，",
                    "将{C:attention}左侧牌{}转换为{C:attention}右侧牌{}",
                    "并将花色变为{C:hearts}#2#{}",
                    "{C:inactive}(拖拽可重新排列)",
                },
            },
            ...
            c_poke_oven = {
                ...
                text = {
                    "{TL:gold}[洛托姆的电器]",
                    "在{C:attention}盲注{}阶段使用",
                    "本回合获得{C:attention}+#1#{}弃牌次数",
                    "{TL:item}[对洛托姆使用]",
                    "转换最左侧或选定的",
                    "{C:attention}洛托姆{}为{C:t_fire}加热{}状态",
                },
            },
            c_poke_washing_machine = {
                ...
                text = {
                    "{TL:gold}[洛托姆的电器]",
                    "在{C:attention}盲注{}阶段使用",
                    "本回合获得{C:attention}+#1#{}手牌",
                    "{TL:item}[对洛托姆使用]",
                    "转换最左侧或选定的",
                    "{C:attention}洛托姆{}为{C:t_water}清洗{}状态",
                },
            },
            c_poke_fridge = {
                name = "冰箱",
                text = {
                    "{TL:gold}[洛托姆的电器]",
                    "生成{C:attention}2{}张随机{C:attention}消耗品",
                    "{C:inactive}(需有空位)",
                    "{TL:item}[对洛托姆使用]",
                    "转换最左侧或选定的",
                    "{C:attention}洛托姆{}为{C:t_water}结冰{}状态",
                },
            },
            c_poke_fan = {
                name = "电风扇",
                text = {
                    "{TL:gold}[洛托姆的电器]",
                    "生成最多{C:attention}2{}张",
                    "{C:blue}普通{}辅助卡",
                    "{C:inactive}(需有空位)",
                    "{TL:item}[对洛托姆使用]",
                    "转换最左侧或选定的",
                    "{C:attention}洛托姆{}为{C:t_bird}旋转{}状态",
                },
            },
            c_poke_lawn_mower = {
                name = "割草机",
                text = {
                    "{TL:gold}[洛托姆的电器]",
                    "在{C:attention}盲注{}阶段使用",
                    "本回合获得{C:attention}+#1#{}手牌上限",
                    "{TL:item}[对洛托姆使用]",
                    "转换最左侧或选定的",
                    "{C:attention}洛托姆{}为{C:t_grass}切割{}状态",
                },
            },
        },
        Energy = {
            ...
            c_poke_psychic_energy = {
                name = "超能力能量",
                text = {
                    "为最左边或选定的{C:attention}超能力{}属性小丑牌",
					"{C:pink}注入能量{}（若可）",
					"{C:inactive}(每张小丑牌可增强{C:attention}#1#{}{C:inactive}次)"
                },
            },
            ...
            c_poke_earth_energy = {
                name = "地能量",
                text = {
                    "为最左边或选定的{C:attention}地面{}属性小丑牌",
					"{C:pink}注入能量{}（若可）",
					"{C:inactive}(每张小丑牌可增强{C:attention}#1#{}{C:inactive}次)"
                },
            },
            c_poke_bird_energy = {
                name = "{X:t_bird,C:white} 鸟之能量 ",
                text = {
                  ""
                },
            },
        ...
        Joker = {
            ...
            j_poke_mega_venusaur = {
                name = "{C:poke_mega}超级{C:edition}妙蛙花",
                text = {
                    "{C:attention}+#1#{} 手牌上限",
                }
            },
            ...
            j_poke_mega_charizard_x = {
                name = "{C:poke_mega}超级{C:edition}喷火龙{C:red}X",
                text = {
                    "当剩余{C:attention}#2#{}次弃牌时，获得{X:mult,C:white} X#1# {} 倍率",
                } 
            },
            j_poke_mega_charizard_y = {
                name = "{C:poke_mega}超级{C:edition}喷火龙{C:blue}Y",
                text = {
                    "{C:red}+#1#{} 次弃牌",
                } 
            },
            ...
            j_poke_mega_blastoise = {
                name = "{C:poke_mega}超级{C:edition}水箭龟",
                text = {
                    "{C:chips}+#2#{} 出牌次数",
                } 
            },
            ...
            j_poke_mega_beedrill = {
                name = "{C:poke_mega}超级{C:edition}大针蜂",
                text = {
                    "{C:chips}+#1#{}筹码",
                } 
            },
            ...
            j_poke_mega_pidgeot = {
                name = "{C:poke_mega}超级{C:edition}大比鸟",
                text = {
                    "若计分手牌包含多种点数和多种花色",
					"给予{X:mult,C:white}X{}倍率，数值等于",
					"你失去的{C:attention}弃牌次数{}",
            ...
            j_poke_golbat = {
                ...
                text = {
					...
					"{C:attention}倍率{} / {C:attention}万能{}牌获得{C:mult}+#2#{}倍率",
            ...
            j_poke_mega_alakazam = {
                name = "{C:poke_mega}超级{C:edition}胡地",
                text = {
                    "{C:attention}+#3#{} 消耗品栏位",
            ...
            j_poke_mega_slowbro = {
                name = "{C:poke_mega}超级{C:edition}呆壳兽",
                text = {
            ...
            j_poke_mega_gengar = {
                name = '{C:poke_mega}超级{C:edition}耿鬼',      
                text = {
            ...
            j_poke_tangela = {
                ...
                text = {
					...
					"{C:inactive,s:0.8}（在打出{C:attention,s:0.8}#6#张万能牌后进化）"
                } 
            },
            j_poke_kangaskhan = {
                name = '袋兽',      
            ...
            j_poke_mega_kangaskhan = {
                name = '{C:poke_mega}超级{C:edition}袋兽',      
                text = {
            ...
            j_poke_scyther = {
                ...
                text = {
					...
					"{C:inactive}（目前为{C:mult}+#1#{C:inactive} 倍率）",
					"{C:inactive,s:0.8}（附上{C:metal,s:0.8}钢{}{C:inactive,s:0.8}贴纸或使用{C:attention,s:0.8}不变之石{C:inactive,s:0.8}后进化）",
                } 
            },
            j_poke_jynx = {
                name = '迷唇姐',      
            ...
            j_poke_electabuzz = {
                ...
                text = {
					...
					"每回合结束时，获得此牌出售价值{C:attention}#2#%{}的金钱{C:inactive}(约){}",
            ...
            j_poke_mega_pinsir = {
                name = '{C:poke_mega}超级{C:edition}凯罗斯',
                text = {
            ...
            j_poke_mega_gyarados = {
                name = '{C:poke_mega}超级{C:edition}暴鲤龙',
                text = {
                    "{X:mult,C:white} X#1# {}倍率",
            ...
            j_poke_ditto = {
                ...
                text = {
					...
					"并附带{C:attention}易腐{}和{C:colorless}一般{}属性贴纸",
					"{C:inactive,s:0.8}（自身除外）",
                } 
            },
            j_poke_eevee = {
                ...
                text = {
                    "{X:mult,C:white} X#1# {} 倍率",
                    "{C:inactive,s:0.8}(进化方式……很多){C:inactive,s:0.8}",
                } 
            },
            j_poke_vaporeon = {
                name = '水伊布',
                text = {
                    "每打出的{C:attention}计分牌{}",
                    "永久获得 {C:chips}+#1#{} 筹码",
                    "{C:attention}加倍{}作用于{C:attention}奖励牌{}",
                } 
            },
            j_poke_jolteon = {
                name = '雷伊布',
            ...
            j_poke_flareon = {
                name = '火伊布',
                text = {
                    "手中第一个{C:attention}倍率{}牌",
                    "{C:attention}持有{}时给予 {X:mult,C:white} X#1# {} 倍率",
                } 
            },
            j_poke_porygon = {
                name = '多边兽',
            ...
            j_poke_mega_aerodactyl = {
                name = '{C:poke_mega}超级{C:edition}化石翼龙',
                text = {
            ...
            j_poke_mega_mewtwo_x = {
                name = "{C:poke_mega}超级{C:edition}超梦{C:red}X",
                text = {
                    "所有小丑牌给予{X:mult,C:white} X#1# {} 倍率",
                } 
            },
            j_poke_mega_mewtwo_y = {
                name = "{C:poke_mega}超级{C:edition}超梦{C:blue}Y",
                text = {
                    "在商店结束时，为最左侧的",
            ...
            j_poke_mew = {
                ...
                text = {
					...
					"有{C:green}#1#%{}的几率产生一张随机的{C:dark_edition}负片{}小丑牌",
            ...
            j_poke_mega_ampharos = {
                name = "{C:poke_mega}超级{C:edition}电龙",
                text = {
                    "{X:mult,C:white} X#1# {} 倍率",
					"选择盲注时，手牌上限变为",
					"牌组数量的{C:attention}一半{}，失去所有",
					"弃牌次数，且只能出 {C:attention}1{} 次牌",
					"{C:inactive}(约数，当前为 {C:attention}#2#{C:inactive})"
                }
            },
            j_poke_marill = {
                name = '玛力露',
            ...
            j_poke_espeon = {
                ...
                text = {
					...
					"{C:inactive,s:0.8}({C:attention,s:0.8}点数{C:inactive,s:0.8}和{C:attention,s:0.8}花色{C:inactive,s:0.8}每次{C:green,s:0.8}商店重掷{C:inactive,s:0.8}时都会随机变化)"
                } 
            },
            j_poke_umbreon = {
                name = '月亮伊布',
                text = {
					...
					"生成一个{C:attention}轨道标签{}或{C:dark_edition}负片标签{}",
					"{C:inactive,s:0.8}(所需的牌型在每次{C:green,s:0.8}商店重掷{C:inactive,s:0.8}时{C:attention,s:0.8}循环{C:inactive,s:0.8})",
                } 
            },
            j_poke_murkrow = {
              name = "黑暗鸦",
            ...
            j_poke_girafarig = {
              ...
              text = {
				...
				"{C:inactive,s:0.8}(在{C:attention,s:0.8}2张{C:inactive,s:0.8}人头牌上使用{C:attention,s:0.8}死亡{C:inactive,s:0.8}后进化){}"
              }
            },
            j_poke_pineco = {
              name = "榛果球",
            ...
            j_poke_mega_steelix = {
                name = "{C:poke_mega}超级{C:edition}大钢蛇",
                text = {
                    "回合结束时，牌组中每有一张",
            ...
            j_poke_qwilfish = {
                ...
                text = {
					...
					"出牌时，手牌中每有一张",
					"{C:attention}陷阱牌{}获得 {C:chips}+#3#{} 筹码",
            ...
            j_poke_mega_scizor = {
                name = "{C:poke_mega}超级{C:edition}巨钳螳螂",
                text = {
                    "{C:blue}普通{}品质的小丑牌",
					"获得 {X:mult,C:white} X#1# {} 倍率",
					"回合结束时，摧毁所有",
            ...
            j_poke_mega_heracross = {
                name = "{C:poke_mega}超级{C:edition}赫拉克罗斯",
                text = {
                    "重新触发所有计分牌{C:attention}两次{}",
                    "{br:2}ERROR - CONTACT STEAK",
                    "若本回合打出或丢弃的牌",
                    "少于{C:attention}5{}张，则削弱自身",
                    "{C:inactive}(在计分前生效减益)"
                },
            },
            j_poke_corsola = {
            ...
            j_poke_skarmory = {
                ...
                text = {
                    "{C:purple}+#1# 陷阱牌 {C:inactive}(每#2#张牌 +1)",
					"手牌中每有一张",
					"{C:attention}陷阱牌{}提供 {X:mult,C:white}X#3#{} 倍率",
            ...
            j_poke_mega_houndoom = {
                name = "{C:poke_mega}超级{C:edition}黑鲁加",
                text = {
                    "弃牌时同时丢弃{C:attention}所有{}手牌",
                    "每次弃牌获得{X:mult,C:white}×#2#{}倍率",
                    "回合结束时重置",
                    "{C:inactive}(当前{X:mult,C:white}×#1#{C:inactive}倍率)"
                }
            },
            j_poke_miltank = {
                name = "大奶罐",
                text = {
                    "每持有{C:colorless}无色(一般属性){}小丑牌，",
					"在回合结束时获得{C:money}$#1#{}",
            ...
            j_poke_mega_tyranitar = {
                name = "{C:poke_mega}超级{C:edition}班基拉斯",
                text = {
                    "若打出的牌是{C:attention}葫芦{},",
					"提升其等级，计分牌永久",
					"获得筹码，数值等于你的",
            ...
            j_poke_sceptile = {
                ...
                text = {
                    "{C:attention}+#3#{}手牌上限, {C:attention}多种性格{}",
					"每张打出的{C:attention}#6#，#7#或#8#{}牌获得{C:money}$#1#{}",
            ...
            j_poke_blaziken = {
                ...
                text = {
					...
					"每张弃掉的{C:attention}#6#，#7#或#8#{}会给予{C:mult}+#4#{}倍率",
					"且你拥有的每张{X:fire,C:white}火{}或{X:earth,C:white}斗{}属性牌",
					"提供 {X:mult,C:white}X#1#{} 倍率",
					"{C:inactive,s:0.8}（这包括小丑牌及能量牌）{}",
            ...
            j_poke_mudkip = {
                ...
                text = {
					...
					"若有其他的{X:water,C:white}水{}或{X:earth,C:white}地{}属性的宝可梦",
                    "给予的筹码翻倍",
					"{C:inactive,s:0.8}（包括宝可梦和能量牌）{}",
            ...
            j_poke_marshtomp = {
                ...
                text = {
                    "{C:chips}+#3#{}出牌次数, {C:attention}多种性格{}",
					"打出的{C:attention}#4#，#5#或#6#{}会给予{C:chips}+#1#{}筹码",
					"如果你有其他的{X:water,C:white}水{}或{X:earth,C:white}地{}属性的牌",
                    "给予的筹码翻倍",
					"{C:inactive,s:0.8}（这包括小丑牌及能量牌）{}",
					"{C:inactive,s:0.8}（在给予{C:chips,s:0.8}#2#{C:inactive,s:0.8}筹码后进化）"
                } 
            ...
            j_poke_poochyena = {
                name = "土狼犬",
                text = {
                "每当一张{C:attention}出牌卡{}被销毁时，",
                "获得 {C:mult}+#2#{} 倍数。",
                "{C:inactive}(当前为 {C:mult}+#1# {C:inactive} 倍数)",
                "{C:inactive,s:0.8}(将在 {C:attention,s:0.8}#3# {C:inactive,s:0.8} 回合后进化)",
                }
            },
            j_poke_mightyena = {
                name = "大狼犬",
            ...
            j_poke_shroomish = {
                ...
                text = {
					...
					"{C:inactive,s:0.8}(击败{C:attention,s:0.8}第#4#赌注{C:inactive,s:0.8}的Boss盲注后进化){}"
                }
            }, 
            j_poke_breloom = {
                name = "斗笠菇",
            ...
            j_poke_numel = {
                name = "呆火驼",
                text = {
                    "每当打出 {C:attention}#3#{} 张计分牌时，",
                    "获得 {X:red,C:white}X#1#{} 倍率",
                    "{C:inactive}剩余#4#张{}",
                    "{C:inactive}(在 {C:attention}#2#{C:inactive} 回合后进化)",
                },
            },
            j_poke_camerupt = {
                name = "喷火驼",
                text = {
                    "每当打出 {C:attention}#2#{} 张计分牌时，",
                    "获得 {X:red,C:white}X#1#{} 倍率，",
                    "其中带有{C:attention}倍率{}牌计数算作两张",
                    "{C:inactive}剩余#3#张{}",
                },
            },
            j_poke_mega_camerupt = {
                name = "{C:poke_mega}超级{C:edition}喷火驼",
                text = {
                    "{C:attention}倍率牌{}参与计分时，",
                    "获得 {X:mult,C:white}X#2#{} 倍率",
                    "在回合结束时重置",
                    "{C:inactive}(当前{X:mult,C:white}×#1#{C:inactive}倍率)",
                },
            ...
            j_poke_duskull = {
                name = "夜巡灵",
                text = {
                    "在本回合的 {C:attention}最终出牌手牌{} 中，",
                    "前 {C:attention}4{} 张计分牌会被再次触发",
                    "{C:inactive}(在 {C:attention}#2#{C:inactive} 回合后进化)",
                },
            },
            j_poke_dusclops = {
                ...
                text = {
                    ...
                    "前 {C:attention}4{} 张计分牌会被再次触发",
                    "{br:2}ERROR - CONTACT STEAK",
                    "如果最终手牌中存在 {C:attention}1{} 张未计分的牌，",
                    "破坏此牌并生成一张 {C:spectral}幻灵牌{}",
                    "{C:inactive}(需要有卡位空间){}",
                    "{C:inactive}(使用 {C:attention}连结绳{C:inactive} 进化)",
                },
            },
            j_poke_absol = {
                name = "阿勃梭鲁",
                text = {
                    ...
                    "所有{C:attention}列出{}的{C:green,E:1,S:1.1}概率{}",
                    "始终为{C:attention}0{}",
            ...
            j_poke_bidoof = {
                name = "大牙狸",
                text = {
                    "商店免费{C:green}重掷{C:attention}#1#{}次",
                    "{C:inactive,s:0.8}(在累计重抽 {C:attention,s:0.8}#2#{C:inactive,s:0.8} 次后进化){}",
                }
            },
            j_poke_bibarel = {
                name = "大尾狸",
                text = {
                    ...
                    "免费 {C:green}重掷{}次数增加{C:attention}#2#{}"
                },
            },
            j_poke_kricketot = {
                name = "圆法师",
                text = {
                    "如果出牌手牌中正好为 {C:attention}4{} 张",
                    "并且至少包含 {C:attention}4{} 种不同的 {C:attention}花色{}，",
                    "则获得 {C:money}$#1#{}",
                    "{C:inactive,s:0.8}(在 {C:attention,s:0.8}#2#{C:inactive,s:0.8} 回合后进化)",
                }
            },
            j_poke_kricketune = {
                ...
                text = {
                    ...
                    "则获得 {C:money}$#1#{}",
                    "{br:2}ERROR - CONTACT STEAK",
                    "{C:green}#2#/#3#{}几率生成一张{C:tarot}塔罗{}牌",
                }
            },
            j_poke_buizel = {
                name = '泳圈鼬',
            ...
            j_poke_lopunny = {
                ...
                text = {
                    ...
                    "获得{C:mult}+#1#{} 倍率",
                    "{br:2}错误-请联系 Steak",
                    "若{C:attention}未计分牌{}与{C:purple}预见牌{}",
                    "具有{C:attention}相同点数{}",
                    "{C:attention}相同点数{}牌获得 {X:mult,C:white}X#2#{} 倍率"
                }
            },
            j_poke_mega_lopunny = {
                name = "{C:poke_mega}超级{C:edition}长耳兔",
                text = {
                    "{C:purple}+#1# 预见",
            ...
            j_poke_lucario = {
                name = "路卡利欧",
                text = {
                    "每张{C:attention}特殊版本{}的手牌",
                    "提供{X:mult,C:white}×#1#{}倍率",
                },
            },
            j_poke_mantyke = {
                name = "小球飞鱼",
            ...
            j_poke_weavile = {
                name = '玛狃拉',
                text = {
                    "若打出的牌仅为一张{C:attention}#3#{}, 则",
					"摧毁它，获得 {C:money}$#4#{} 并获得 {X:mult,C:white}X#1#{} 倍率",
            ...
            j_poke_togekiss = {
                ...
                text = {
					...
					"以及{C:green}#1#/#3#{}的几率提供{X:mult,C:white}X#5#{} 倍率",
					"对所有{C:attention}几率牌{}的{C:green,E:1,S:1.1}几率{}加{C:attention}#6#{}",
                }
            },
            j_poke_yanmega = {
              name = "远古巨蜓",
            ...
            j_poke_leafeon = {
                ...
                text = {
                    ...
                    "每次出牌减少 {C:red}#2#{}",
                    "{br:2}ERROR - CONTACT STEAK",
                    "成功触发{C:attention}幸运牌{}时",
                    "获得 {C:attention}+#2#{} 手牌上限",
                    "{C:inactive}(最多可达到 {C:attention}+#3#{C:inactive} 手牌上限){}"
                } 
            },
            j_poke_glaceon = {
                name = '冰伊布',
            ...
            j_poke_dusknoir = {
                ...
                text = {
                    ...
                    "{C:attention}最后一手记分牌{}",
                    "{br:2}ERROR - CONTACT STEAK",
                    "商店可刷新{C:spectral}幻灵牌{}",
                    "{C:inactive,s:0.8}(如果它们已经会出现，则提升出现率){}"
                },
            },
            j_poke_froslass = {
                name = "雪妖女",
            ...
            j_poke_rotom = {
                name = "洛托姆",
                text = {
                    "打开{C:attention}补充包{}时有{C:green}#1#/#2#{}几率",
                    "生成{C:item}道具{}卡",
                    "{C:inactive}(需有空位){}",
                    "{br:2}错误 - 请联系 STEAK",
                    "{C:attention}补充包{}价格降低{X:money,C:white}$1{}",
                    "{C:inactive}(使用{C:attention}电器{C:inactive}后转换形态){}",
                },
            },
            j_poke_rotomh = {
                name = "洛托姆(加热)",
                text = {
                    ...
                    "{C:inactive}(需有空位){}",
                    "{br:2}错误 - 请联系 STEAK",
                    "若首次弃牌刚好为{C:attention}2{}张",
                    "则将两张牌强化为{C:attention}倍率{}牌",
                    "{C:inactive}(使用{C:attention}电器{C:inactive}后转换形态){}"
                },
            },
            j_poke_rotomw = {
                ...
                text = {
                    ...
                    "{C:inactive}(需有空位){}",
                    "{br:2}错误 - 请联系 STEAK",
                    "每张打出的{C:attention}强化{}牌",
                    "获得{X:money,C:white}$#3#{}但移除强化效果",
                    "{C:inactive}(使用{C:attention}电器{C:inactive}后转换形态){}"
                },
            },
            j_poke_rotomf = {
                ...
                text = {
                    ...
                    "{br:2}错误 - 请联系 STEAK",
                    "选择盲注时生成随机",
                    "{C:attention}消耗品{}并附加{C:dark_edition}闪箔{}、",
                    "{C:dark_edition}全息{}或{C:dark_edition}彩闪{}效果",
                    "{C:inactive}(使用{C:attention}电器{C:inactive}后转换形态){}"
                },
            },
            j_poke_rotomfan = {
            ...
            j_poke_rotomm = {
                ...
                text = {
                    ...
                    "手牌前{C:attention}2{}张牌的等级",
                    "{C:inactive}(使用{C:attention}电器{C:inactive}后转换形态){}"
                },
            },
            j_poke_shaymin = {
                name = "{C:dark_edition}谢米",
                text = {
                    "回合{C:attention}首次{}打出的",
                    "{C:attention}最右侧{}计分牌变为{C:attention}花牌{}",
                    "{C:inactive,s:0.8}(在累计得分 {C:attention,s:0.8}#1# {C:inactive,s:0.8} 张花卡后",
                    "转换为{C:legendary}天空形态{})"
                },
            },
            j_poke_shaymin_sky = {
                name = "{C:dark_edition}谢米{C:legendary}(天空形态)",
                text = {
                    "{C:attention}花牌{}视为{C:attention}万能牌{}",
                    "使用{C:attention}塔罗牌{X:tarot,C:white}死神{}后",
                    "转换为{C:grass}通常形态"
                },
            },
            j_poke_pansage = {
            ...
            j_poke_roggenrola = {
                ...
                text = {
                    "{C:purple}+#1# 陷阱牌 {C:inactive}(每#2#张牌 +1)",
					"手牌中每有一张{C:attention}陷阱牌{}",
					"提供 {C:mult}+#3#{} 倍率",
					"{C:inactive,s:0.8}(触发陷阱牌{C:attention,s:0.8}#4#{C:inactive,s:0.8}次后进化)",
                }
            },
            j_poke_boldore = {
                name = "地幔岩",
            ...
            j_poke_drilbur = {
                ...
                text = {
                    "销毁每回合首张计分的(次OR张?)",
                    "{C:attention}石头牌{}并生成{C:money}宝藏{}",
                    "{C:inactive}(需有空位)",
            ...
            j_poke_excadrill = {
                name = "龙头地鼠",
                text = {
                        "销毁计分的{C:attention}石头牌{}",
                        "并生成{C:money}宝藏{}",
                        "{C:inactive}(需有空位)",
                        "{br:2}错误 - 请联系 STEAK",
                        "牌组每比{C:attention}#2#{}少一张牌",
                        "提供{C:mult}+#1#{}倍率",
                        "{C:inactive}(当前为 {C:mult}+#3#{C:inactive} 倍数)",
                },
            },
            j_poke_trubbish = {
                name = "破破袋",
                text = {
                    "本回合若{C:attention}未使用{C:red}弃牌",
                    "回合结束获得 {C:chips}+#2#{} 筹码",
                    "每次弃牌可额外获得 {C:money}$#3#{}",
            ...
            j_poke_garbodor = {
                ...
                text = {
                    "本回合若{C:attention}未使用{C:red}弃牌",
                    "回合结束获得 {C:chips}+#2#{} 筹码（*弃牌次数？）",
                    "{br:2}错误 - 请联系 STEAK",
                    "{C:attention}本轮{}若{C:attention}未使用{C:red}弃牌",
                    "击败BOSS盲注时生成",
                    "{C:attention}垃圾标签{}",
                    "{C:inactive}(当前为 {C:chips}+#1#{C:inactive} 筹码)",
                },
            ...
            j_poke_jellicent = {
                ...
                text = {
                    ...
                    "获得 {C:chips}+#2#{} 筹码",
                    "{br:3}错误 - 请联系 STEAK",
                    "若弃牌为{C:attention}K{}或{C:attention}Q{}",
                    "则获得 {C:attention}双倍{} 筹码",
                    "{C:inactive}(当前为 {C:chips}+#1#{C:inactive} 筹码)",
                },
            },
            j_poke_ferroseed = {
                name = "种子铁球",
                text = {
                    "{C:attention}万能牌{} 和 {C:attention}危险牌{}",
                    "也会被视为 {C:attention}钢{} 牌",
                    "{C:inactive,s:0.8}(经过 {C:attention,s:0.8}#1#{C:inactive,s:0.8} 回合后进化)",
                },
            },
            j_poke_ferrothorn = {
            ...
            j_poke_pawniard = {
                name = "驹刀小兵",
                text = {
                "每销毁一张{C:attention}人头牌{}",
                "获得 {X:red,C:white}X#2#{} 倍数",
                "{C:inactive}(在倍数达到 {X:mult,C:white}X#1#{C:inactive} / {X:inactive,C:white}X#3#{C:inactive} 时进化)",
                }
            },
            j_poke_bisharp = {
            name = "劈斩司令",
            text = {
                ...
                "{br:2}错误 - 请联系 STEAK",
                "若首回合出牌只有一张",
                "{C:attention}人头牌{}则将其销毁",
                "{C:inactive}(当前为 {X:mult,C:white}X#1#{C:inactive} 倍数)",
                "{C:inactive,s:0.8}(在破坏 {C:attention,s:0.8}#3#{C:inactive,s:0.8} 张国王牌后进化)",
            }
            },
            j_poke_zweilous = {
                name = "双首暴龙",
            ...
            j_poke_sylveon = {
                ...
                text = {
                    "如果{C:attention}第一手牌{}",
                    "正好是 {C:attention}1{} 张未被强化的牌，",
                    "则为其添加 {C:dark_edition}闪箔{}、{C:dark_edition}镭射{}",
            ...
            j_poke_pumpkaboo_small = {
                name = "南瓜精（小型）",
                text = {
                    "在弃掉 {C:attention}#1#{} 张 {C:inactive}[#2#]{} {C:attention}J牌 后，",
                    "生成一张 {C:spectral}幽灵{} 卡",
                    "{C:inactive}(需要有空间)",
                    "{C:inactive,s:0.8}(使用 {C:attention,s:0.8}连结绳{C:inactive,s:0.8} 进化)"
                }
            },
            ...
            j_poke_gourgeist_small = {
                name = "南瓜怪人（小型）",
                text = {
                    "在弃掉 {C:attention}#1#{} 张 {C:inactive}[#2#]{} {C:attention}J 牌后，",
                    "生成一张 {C:spectral}幽灵{} 卡",
                    "{C:inactive}(需要有空位)",
                    "{br:2}错误 - 请联系 STEAK",
                    "当一张 {C:spectral}幽灵{} 卡被使用时，获得 {C:money}$#3#{}，并为",
                    "{C:attention}最左侧{}的小丑贴上一个 {X:psychic,C:white}超能{} 贴纸"
                }
            },
            ...
            j_poke_rockruff = {
                name = "岩狗狗",
                text = {
                    "{C:attention}非人头牌{}计分时",
                    "提供{C:mult}+#1#{}倍率",
                    "{C:inactive,s:0.8}(在累计得分{C:attention,s:0.8}#2#{C:inactive,s:0.8}张偶数点数牌后进化鬃岩狼人（白昼）)",
                    "{C:inactive,s:0.8}(在累计得分{C:attention,s:0.8}#3#{C:inactive,s:0.8}张奇数点数牌后进化鬃岩狼人（黑夜)",
                },
            },
            j_poke_lycanroc_day = {
                name = "鬃岩狼人（白昼）",
                text = {
                    ...
                    "{br:3}错误 - 联系 STEAK",
                    "每回合首次出牌",
                    "只有{C:attention}1张牌{}计分时", 
                    "提供{C:chips}+#2#{}筹码和{C:attention}+1{}出牌次数"
                },
            },
            ...
            j_poke_lycanroc_dusk = {
                ...
                text = {
                    ...
                    "{br:3}错误 - 联系 STEAK",
                    "重新触发",
                    "{C:attention}首张{}记分的{C:attention}偶数{}牌",
                    "和{C:attention}首张{}记分的{C:attention}奇数{}牌",
                },
            },
            j_poke_mimikyu = {
                name = "谜拟丘",
            ...
            j_poke_tarountula = {
                ...
                text = {
                    "{C:purple}+#1# 陷阱牌 {C:inactive}(每#2#张牌 +1)",
					"回合结束时，手牌中每有",
					"{C:attention}#4# 张陷阱牌{}，生成一张{C:planet}星球{}牌",
					"{C:inactive}(必须有空间)",
					"{C:inactive,s:0.8}(在{C:attention,s:0.8}#3#{C:inactive,s:0.8}回合后进化)",
                }
            },
            j_poke_spidops = {
                ...
                text = {
                    "{C:purple}+#1# 陷阱牌 {C:inactive}(每#2#张牌 +1)",
					"在回合结束时，为你手中每",
					"第三张{C:attention}陷阱牌{}添加{C:chips}蓝色蜡封{}",
                }
            },
            j_poke_fidough = {
                name = "偶叫獒",
            ...
            j_poke_charcadet = {
                ...
                text = {
                    ...
                    "{C:inactive,s:0.8}(回合结束时重置)",
                    "{C:inactive}(当前{C:mult}+#1#{C:inactive}倍率)",
                    "{C:inactive,s:0.8}(使用 {C:attention,s:0.8}日之石{C:inactive,s:0.8}进化红莲铠骑)",
                    "{C:inactive,s:0.8}(使用 {C:attention,s:0.8}暗之石{C:inactive,s:0.8}进化苍炎刃鬼)"
                },
            },
            j_poke_armarouge = {
                name = "红莲铠骑",
            ...
            j_poke_ceruledge = {
                name = "苍炎刃鬼",
                text = {
                    "每出牌一次获得{X:mult,C:white}X#2#{}倍率",
                    "并从随机宝可梦吸取{X:money,C:white}$#3#{}",
                    "{C:inactive,s:0.8}(回合结束时重置)",
                    "{C:inactive}(当前{X:mult,C:white}X#1#{C:inactive}倍率)",
                },
            },
            ...
            j_poke_rotomdex = {
                name = '洛托姆图鉴',
                text = {
                    "每有一种不同{C:pink}属性{}宝可梦",
                    "{C:attention}补充包{}价格降低{X:money,C:white}$1{}",
                    "{C:inactive}(当前降低{X:money,C:white}$#1#{C:inactive})"
                },
            },
            j_poke_everstone = {
                name = '不变之石',
            ...
            j_poke_professor = {
                name = "博士",
                text = {
                    "{C:attention}#1#{}回合后出售此卡",
                    "生成{C:attention}初学者{}标签",
                    "{C:inactive}(当前{C:attention}#2#{C:inactive}/#1#回合){}"
                },
            },
            j_poke_mystery_egg = {
                name = "神秘蛋",
        ...
        Sleeve = {
            sleeve_poke_pokemonsleeve = {
                name = "训练家牌套",
                text = {
                    "开局时获得","{C:tarot,T:v_poke_goodrod}#1#{}优惠券及","一张 {C:tarot,T:c_poke_pokeball}#2#{}牌",
                },
            },
            ...
            sleeve_poke_telekineticsleeve = {
                name = "念动力牌套",
                text = {
                    "开局时获得","{C:tarot,T:v_crystal_ball}#1#{}优惠券","和{C:attention}2{}张","{C:item,T:c_poke_twisted_spoon}#2#{}",
                } 
            },
            sleeve_poke_ampedsleeve = {
                name = "增幅牌套",
                text = {
                    "开局时获得","{C:tarot,T:v_poke_energysearch}#1#{}优惠券","和一张","{C:pink,T:c_poke_double_rainbow_energy}#2#{}",
                } 
            },
        ...
        Spectral = {
            ...
            c_poke_megastone = {
                name = "{C:poke_mega}超级{C:edition}石",
                text = {
                    "{C:attention}可重复使用{}",
                    "{br:2}ERROR - CONTACT STEAK",
                    "{C:attention}超级进化{}一只宝可梦", 
                    "或{C:attention}退化{}超级形态",
                    "{X:green,C:white,s:1.1}出售{}时{C:attention}退出{}超级形态",
                    "{C:inactive}(每回合限用一次)",
                },
            },
            c_poke_obituary = {
        ...
        Tag = {
            tag_poke_pocket_tag = {
                name = "宝可梦标签",
                text = {
                    "获得一个免费的{C:pink}超级宝可梦包{}",
					"{C:attention}蓝注{}以上难度有{C:green}#1#%{}几率",
					"含有{C:attention}超级石{}",
					"{C:inactive,s:0.8}(几率不能提升){}",
                }, 
            },
        ...
        Other = {
            ...
            rewards_ruins_of_alph = {
                name = "奖励",
                text = {
                    "{C:attention}#1#{} - 一只{C:attention}狩猎地带{}宝可梦",
					"{C:attention}#2#{} - {C:attention}复制{}一只随机小丑牌",
            ...
            deli_gift = {
                ...
                text = {
					...
					"{C:green}30%{} - {C:attention}一张{C:item}道具{}牌",
					"{C:green}20%{} - {C:attention}一张优惠券标签",
					"{C:green}15%{} - {C:attention}一张{C:dark_edition}多彩{}版本的礼物卡",
                }
            },
            pickup = {
              name = "抽选",
            ...
            precise_energy_tooltip = {
                ...
                text = {
					...
					"{s:0.8}{C:attention,s:0.8}关闭{}此选项时，将发生以下情况:{}","{C:attention}1. {X:mult,C:white,s:0.8}X{} {s:0.8}倍率 - 使用小数","{C:attention}2. {s:0.8}+ {C:mult,s:0.8}倍率{}和{C:chips,s:0.8}筹码{} - 四舍五入到最近的整数","{C:attention}3. {s:0.8}{C:mult,s:0.8}倍率增长{}和{C:chips,s:0.8}筹码增长{} - 小数部分显示为",
					"{s:0.8}百分比，用于增加基础{C:mult,s:0.8}倍率{}和{C:chips,s:0.8}筹码{}","{C:attention}4. {C:money,s:0.8}${}{s:0.8} - 小数部分显示为百分比，","{s:0.8}作为获得额外{C:money,s:0.8}${}{s:0.8}的概率{}","{C:inactive,s:0.8}(非宝可梦小丑牌将始终使用精准计量){}"
                }
            },
            discovery_tooltip = {
              name = "探索内容",
              text = {
                "默认情况下，所有宝可梦内容都需要自行探索发现。",
				"禁用此设置将为你解锁所有模组内容。",
				"{C:red}解锁所有内容后将无法撤销{}"
              }
            }, 
            ...
            safaridesc = {
                ...
                text = {
                    "只可以通过",
					"{C:attention}进化{}或特定的{C:attention}精灵球{}",
					"来获得此牌"
                } 
            },
            ...
            poke_silver_seal = {
                name = "白银蜡封",
                text = {
                    "若此牌在计分后仍{C:attention}在手牌中{} ",
                    "获得一张{C:item}道具牌{}并将此牌{C:attention}弃置{}"
                }
            },
            --[[
            grass_sticker = {
    ...
    misc = {
        ...
        dictionary = {
            k_energy = "能量",
            k_item = "道具",
            k_poke_pocket_pack = "宝可梦包",
            k_poke_wish_pack = "许愿包",
            k_poke_starter_pack = "初学者包",
        ...
        tutorial = {
          poke_intro_1 = {
          "你好，我是 {C:attention}Jimbo 教授{}！","欢迎来到{C:attention}宝可牌{}的世界！",
          },
        },
        v_dictionary = {
        ...
        v_text = {
           ...
           ch_c_poke_nuzlocke = {"每个赌注的第一个商店必定有{C:attention}丑角礼包"},
